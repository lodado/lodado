...
안녕하세요, 늘 배우며 성장하는 프론트엔드 개발자 이충헌입니다.

다양한 분야에 관심이 많고 늘 배우며 성장하는 자세로 살고 있습니다!

기술과 지식을 단순 `사용`보다는 깊게 `이해`하는 개발자가 되고자 합니다.

요즘은 구현을 넘어서서 변경과 확장에 유연한 소프트웨어를 만들기 위해 늘 고민하고 공부하고 있습니다.
